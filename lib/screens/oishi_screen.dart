...
class OishiScreen extends StatefulWidget {
  @override
  _OishiScreenState createState() => _OishiScreenState();
}

class _OishiScreenState extends State<OishiScreen> {
