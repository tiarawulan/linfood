...
class GepreNusantarakScreen extends StatefulWidget {
  @override
  _GepreNusantarakScreenState createState() => _GepreNusantarakScreenState();
}

class _GepreNusantarakScreenState extends State<GepreNusantarakScreen> {
  ...
  final List<MenuItem> rekomendasi = [
    MenuItem(
      name: 'Ayam Geprek Sambal Pedas Mamis + Nasi free teh es',
      price: '12k',
      image: 'assets/geprek_komplit_nasi.png',
    ),
    MenuItem(
      name: 'Ayam Geprek Sambal Ijau + Nasi free teh es',
      price: '12k',
      image: 'assets/3t.png',
    ),
  ];
  ...
  final Map<String, List<MenuItem>> menuItems = {
    'Makanan': [
      ...
      MenuItem(
        name: 'Ayam Geprek Sambal Pedas Mamis',
        price: '10k',
      ...
      MenuItem(
        name: 'Ayam Geprek Sambal Ijau',
        price: '10k',
        image: 'assets/geprek_komplit.png',
      ),
      MenuItem(
        name: 'Ayam Geprek Sambal Terasi + Nasi free teh es',
        price: '12k',
        image: 'assets/geprek_komplit.png',
      ),
      MenuItem(
      ...
      MenuItem(
        name: 'Ayam Geprek Sambal Mentah + Nasi free teh es',
        price: '12k',
        image: 'assets/geprek_komplit.png',
      ),
      MenuItem(
        name: 'Ayam Geprek Sambal Mentah',
        price: '10k',
        image: 'assets/geprek_komplit.png',
      ),
      MenuItem(
        name: 'KFC + Nasi free teh es',
        price: '12k',
